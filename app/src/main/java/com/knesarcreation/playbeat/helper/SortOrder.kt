...
import com.knesarcreation.playbeat.ALBUM_ARTIST
...
class SortOrder {
    ...
    interface SongSortOrder {
        ...
        companion object {
            ...
            const val SONG_ARTIST_ASC = MediaStore.Audio.Artists.DEFAULT_SORT_ORDER

            /* Song sort order artist DESC */
            const val SONG_ARTIST_DESC = "$SONG_ARTIST_ASC DESC"

            /* Song sort order album artist */
            const val SONG_ALBUM_ARTIST_ASC = ALBUM_ARTIST

            /* Song sort order album artist DESC */
            const val SONG_ALBUM_ARTIST_DESC = "$SONG_ALBUM_ARTIST_ASC DESC"

            /* Song sort order album */
            const val SONG_ALBUM_ASC = MediaStore.Audio.Albums.DEFAULT_SORT_ORDER

            /* Song sort order album DESC */
            const val SONG_ALBUM_DESC = "$SONG_ALBUM_ASC DESC"

            /* Song sort order year */
            const val SONG_YEAR_DESC = MediaStore.Audio.Media.YEAR + " DESC"

            /* Song sort order year ASC*/
            const val SONG_YEAR_ASC = MediaStore.Audio.Media.YEAR

            /* Song sort order duration DESC */
            const val SONG_DURATION_DESC = MediaStore.Audio.Media.DURATION + " DESC"

            /* Song sort order duration ASC */
            const val SONG_DURATION_ASC = MediaStore.Audio.Media.DURATION

            /* Song sort order date */
            const val SONG_DATE_DESC = MediaStore.Audio.Media.DATE_ADDED + " DESC"

            /* Song sort order date ASC */
            const val SONG_DATE_ASC = MediaStore.Audio.Media.DATE_ADDED

            /* Song sort modified date */
            const val SONG_DATE_MODIFIED_DESC = MediaStore.Audio.Media.DATE_MODIFIED + " DESC"

            /* Song sort modified date ASC */
            const val SONG_DATE_MODIFIED_ASC = MediaStore.Audio.Media.DATE_MODIFIED

            /* Song sort order composer*/
            const val COMPOSER_ACS = MediaStore.Audio.Media.COMPOSER

            /* Song sort order composer*/
            const val COMPOSER_DESC = "$COMPOSER_ACS DESC"
        }
    }
    ...
    interface AlbumSongSortOrder {
        ...
        companion object {
            ...
            const val SONG_DURATION = SongSortOrder.SONG_DURATION_DESC
        }
    }
