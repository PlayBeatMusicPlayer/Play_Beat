...
interface AlbumDao {
    ...
    @Query("update albumModel  set  albumName = :albumName , artistName = :artistName , artUri = :artUri where id = :albumId")
    ...
    @Query("Update albumModel set songCount =:songCount where id = :albumId")
