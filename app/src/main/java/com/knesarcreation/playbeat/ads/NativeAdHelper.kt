...
class NativeAdHelper(var context: Context) {
    ...
    private fun populateUnifiedNativeAdView(nativeAd: NativeAd, adView: NativeAdView) {
        ...
        adView.findViewById<FrameLayout>(R.id.skipNativeAd).setOnClickListener {
            nativeAdViewL.animate().setDuration(1000).alpha(0f)
            nativeAd.destroy()
        }
    ...
    fun refreshAd(ad_frame: FrameLayout, adId: String) {
        ...
        builder.forNativeAd { nativeAd ->
            ...
            val adView = (context as AppCompatActivity).layoutInflater.inflate(
                R.layout.ad_native, null
            ) as NativeAdView
        ...
        val adLoader = builder.withAdListener(object : AdListener() {
          ...
          """"
                ...
                Log.d(
                    "NativeAdFailed",
                    "onAdFailedToLoad: Failed to load native ad with error $error "
                )
            }
        }).build()
