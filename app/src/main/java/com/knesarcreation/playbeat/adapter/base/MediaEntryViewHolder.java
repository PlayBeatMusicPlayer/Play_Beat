...
package com.knesarcreation.playbeat.adapter.base;
...
public class MediaEntryViewHolder extends AbstractDraggableSwipeableItemViewHolder
    ...
    @Nullable
    public RelativeLayout rlCurrentPlayingLottie;
    ...
    public MediaEntryViewHolder(@NonNull View itemView) {
        ...
        equalizerView = itemView.findViewById(R.id.equalizerView);
        rlCurrentPlayingLottie = itemView.findViewById(R.id.rlCurrentPlayingLottie);
