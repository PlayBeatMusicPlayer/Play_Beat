...
import com.knesarcreation.playbeat.helper.MusicPlayerRemote.isPlaying
import com.knesarcreation.playbeat.helper.MusicPlayerRemote.playNextSong
    ...
    inner class ViewHolder(itemView: View) : SongAdapter.ViewHolder(itemView) {
        ...
        init {
            ...
            menu?.setOnClickListener {
                BottomSheetSongMenuHelper(activity, 1).handleMenuClick(song, layoutPosition)
            }
        }
