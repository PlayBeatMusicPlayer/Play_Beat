...
import com.knesarcreation.playbeat.cast.RetroWebServer.Companion.MIME_TYPE_AUDIO
import com.knesarcreation.playbeat.cast.RetroWebServer.Companion.PART_COVER_ART
import com.knesarcreation.playbeat.cast.RetroWebServer.Companion.PART_SONG
...
object CastHelper {
    ...
    private fun Song.toMediaInfo(): MediaInfo? {
        ...
        val baseUrl: URL
        try {
            baseUrl = URL(CAST_URL_PROTOCOL, PlayBeatUtil.getIpAddress(true), SERVER_PORT, "")
