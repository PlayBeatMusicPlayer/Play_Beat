...
import com.knesarcreation.playbeat.extensions.getIntRes
import com.knesarcreation.playbeat.extensions.getStringOrDefault
...
import com.knesarcreation.playbeat.fragments.folder.FoldersFragment
import com.knesarcreation.playbeat.helper.SortOrder.*
import com.knesarcreation.playbeat.model.CategoryInfo
import com.knesarcreation.playbeat.transform.*
import com.knesarcreation.playbeat.util.theme.ThemeMode
import com.knesarcreation.playbeat.views.TopAppBarLayout
import java.io.File
...
object PreferenceUtil {
    ...
    fun themeResFromPrefValue(themePrefValue: String): Int {
        return when (themePrefValue) {
            ...
            "dark" -> R.style.Theme_PlayBeat
            else -> R.style.Theme_PlayBeat
        }
    }
    ...
    var nowPlayingScreen: NowPlayingScreen
        get() {
            ...
            return NowPlayingScreen.Material
        }
        set(value) = sharedPreferences.edit {
    ...
    val lastAddedCutoff: Long
        get() {
            val calendarUtil = CalendarUtil()
            val interval =
                when (sharedPreferences.getStringOrDefault(LAST_ADDED_CUTOFF, "this_year")) {
                    "today" -> calendarUtil.elapsedToday
                    "this_week" -> calendarUtil.elapsedWeek
                    "past_three_months" -> calendarUtil.getElapsedMonths(3)
                    "this_year" -> calendarUtil.elapsedYear
                    "this_month" -> calendarUtil.elapsedMonth
                    else -> calendarUtil.elapsedYear
                }
    ...
    var sleepTime
        get() = sharedPreferences
            .getLong(SLEEP_TIME, 0L)
        set(value) = sharedPreferences.edit { putLong(SLEEP_TIME, value).apply() }


    var isSleepTimeEnable
        get() = sharedPreferences
            .getBoolean(SLEEP_TIME_ENABLED, false)
        set(value) = sharedPreferences.edit { putBoolean(SLEEP_TIME_ENABLED, value) }
}
