...
import com.knesarcreation.playbeat.util.AutoGeneratedPlaylistBitmap
import kotlinx.coroutines.*
import java.util.concurrent.Executors

class SongPlaylistPreviewFetcher(
    val context: Context,
    private val playlistPreview: PlaylistSongsPreview
) :
            ...
            try {
                val bitmap =
                    AutoGeneratedPlaylistBitmap.getBitmap(
                        context,
                        playlistPreview.playlistSongs.shuffled()
                    )
