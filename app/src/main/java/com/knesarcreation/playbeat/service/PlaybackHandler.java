...
import static com.knesarcreation.playbeat.service.MusicService.DUCK;
import static com.knesarcreation.playbeat.service.MusicService.META_CHANGED;
import static com.knesarcreation.playbeat.service.MusicService.PLAY_STATE_CHANGED;
import static com.knesarcreation.playbeat.service.MusicService.REPEAT_MODE_NONE;
import static com.knesarcreation.playbeat.service.MusicService.TRACK_ENDED;
import static com.knesarcreation.playbeat.service.MusicService.TRACK_WENT_TO_NEXT;
        ...
        switch (msg.what) {
            ...
            case TRACK_WENT_TO_NEXT:
                if (service.pendingQuit
                    ...
                    service.pause();
                    Log.d("SleepTimeAudioPaused", "pause:  Playback handler");
                    service.seek(0);
                    if (service.pendingQuit) {
