...
import com.knesarcreation.playbeat.activities.saf.SAFGuideActivity
...
import com.knesarcreation.playbeat.repository.Repository
import com.knesarcreation.playbeat.util.PlayBeatUtil
import com.knesarcreation.playbeat.util.SAFUtil
...
abstract class AbsTagEditorActivity<VB : ViewBinding> : AbsBaseActivity() {
    ...
    protected fun writeValuesToFiles(
        ...
        PlayBeatUtil.hideSoftKeyboard(this)
